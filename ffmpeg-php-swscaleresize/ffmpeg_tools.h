...
int ffmpeg_img_convert(
        AVFrame *dst, int dst_pix_fmt,
        AVFrame *src, int src_pix_fmt,
        unsigned int src_width, unsigned int src_height);

int ffmpeg_img_resample(
        AVFrame *src, int src_fmt, unsigned int src_width, 
        unsigned int src_height, AVFrame *dst, unsigned int dst_width, 
